...
#pen_img = cv2.imread('pen.jpg',1)
#eraser_img = cv2.imread('eraser2.png',1)
#print(pen_img.shape())
#print(eraser_img.shape())
pen_img = cv2.resize(cv2.imread('pen.jpg',1), (50, 50),cv2.INTER_AREA)
eraser_img = cv2.resize(cv2.imread('eraser2.png',1), (50, 50))
cap.set(3,1280)
cap.set(4,720)
...
while(1):
    ...
    if contours and cv2.contourArea(max(contours,
        ...
        if area > wiper_thresh:
           cv2.putText(canvas,'Clearing Screen', (100,200), 
